...
(function(t) {
    ...
    function s() {
        ...
        this.dpDiv = n(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui_widget_content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function n(e) {
    ...
    t.widget("ui.accordion", {
        ...
        _processPanels: function() {
            ...
            this._addClass(this.panels, "ui-accordion-content", "ui-helper-reset ui_widget_content"),
    ...
    t.widget("ui.menu", {
        ...
        _create: function() {
            ...
            this._addClass("ui-menu", "ui-widget ui_widget_content"),
            this._on({
                "mousedown .ui_menu_item": function(t) {
                    t.preventDefault()
                },
                "click .ui_menu_item": function(e) {
                    var i = t(e.target)
                ...
                "mouseenter .ui_menu_item": function(e) {
                    if (!this.previousFilter) {
                        var i = t(e.target).closest(".ui_menu_item")
                          , s = t(e.currentTarget);
        ...
        _destroy: function() {
            var e = this.element.find(".ui_menu_item").removeAttr("role aria-disabled")
              , i = e.children(".ui_menu_item-wrapper").removeUniqueId().removeAttr("tabIndex role aria-haspopup");
        ...
        _keydown: function(e) {
            ...
            default:
                ...
                i = o && -1 !== i.index(this.active.next()) ? this.active.nextAll(".ui_menu_item") : i,
        ...
        refresh: function() {
            ...
            this._addClass(s, "ui-menu", "ui-widget ui_widget_content ui-front"),
            e = h.add(this.element),
            i = e.find(this.options.items),
            i.not(".ui_menu_item").each(function() {
                var e = t(this);
                a._isDivider(e) && a._addClass(e, "ui-menu-divider", "ui_widget_content")
            }),
            n = i.not(".ui_menu_item, .ui-menu-divider"),
            o = n.children().not(".ui-menu").uniqueId().attr({
                tabIndex: -1,
                role: this._itemRole()
            }),
            this._addClass(n, "ui_menu_item")._addClass(o, "ui_menu_item-wrapper"),
        ...
        focus: function(t, e) {
            ...
            this.active = e.first(),
            s = this.active.children(".ui_menu_item-wrapper"),
            this._addClass(s, null, "ui-state-active"),
            this.options.role && this.element.attr("aria-activedescendant", s.attr("id")),
            n = this.active.parent().closest(".ui_menu_item").children(".ui_menu_item-wrapper"),
        ...
        blur: function(t, e) {
            ...
            this.active && (this._removeClass(this.active.children(".ui_menu_item-wrapper"), null, "ui-state-active"),
        ...
        collapse: function(t) {
            var e = this.active && this.active.parent().closest(".ui_menu_item", this.element);
        ...
        isFirstItem: function() {
            return this.active && !this.active.prevAll(".ui_menu_item").length
        },
        isLastItem: function() {
            return this.active && !this.active.nextAll(".ui_menu_item").length
        },
        _move: function(t, e, i) {
            var s;
            this.active && (s = "first" === t || "last" === t ? this.active["first" === t ? "prevAll" : "nextAll"](".ui_menu_item").eq(-1) : this.active[t + "All"](".ui_menu_item").eq(0)),
        ...
        nextPage: function(e) {
            ...
            this.active.nextAll(".ui_menu_item").each(function() {
                return i = t(this),
                0 > i.offset().top - s - n
            }),
        ...
        previousPage: function(e) {
            ...
            n = this.element.height(),
            this.active.prevAll(".ui_menu_item").each(function() {
                return i = t(this),
                i.offset().top - s + n > 0
            }),
        ...
        select: function(e) {
            this.active = this.active || t(e.target).closest(".ui_menu_item");
            var i = {
                item: this.active
            };
        ...
        _filterMenuItems: function(e) {
            var i = e.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&")
              , s = RegExp("^" + i, "i");
            return this.activeMenu.find(this.options.items).filter(".ui_menu_item").filter(function() {
                return s.test(t.trim(t(this).children(".ui_menu_item-wrapper").text()))
            })
        }
    }),
    ...
    t.widget("ui.controlgroup", {
        ...
        _initWidgets: function() {
            ...
            t.each(this.options.items, function(s, n) {
                ...
                e._addClass(o, null, "ui-widget ui_widget_content ui-state-default"),
                i = i.concat(o.get()),
        ...
        _selectmenuOptions: function(t) {
            ...
            return {
                ...
                classes: {
                    middle: {
                        "ui_selectmenu_button-open": "",
                        "ui_selectmenu_button-closed": ""
                    },
                    first: {
                        "ui_selectmenu_button-open": "ui-corner-" + (e ? "top" : "tl"),
                        "ui_selectmenu_button-closed": "ui-corner-" + (e ? "top" : "left")
                    },
                    last: {
                        "ui_selectmenu_button-open": e ? "" : "ui-corner-tr",
                        "ui_selectmenu_button-closed": "ui-corner-" + (e ? "bottom" : "right")
                    },
                    only: {
                        "ui_selectmenu_button-open": "ui-corner-top",
                        "ui_selectmenu_button-closed": "ui-corner-all"
                    }
                }[t]
            }
        },
    ...
    t.extend(s.prototype, {
        ...
        _newInst: function(e, i) {
            ...
            return {
                ...
                drawYear: 0,
                inline: i,
                dpDiv: i ? n(t("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui_widget_content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
            }
        },
        ...
        _generateHTML: function(t) {
            ...
            l = j ? "<div class='ui-datepicker-buttonpane ui_widget_content'>" + (Y ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (Y ? "" : h) + "</div>" : "",
    ...
    t.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            this._addClass("ui-dialog-content", "ui_widget_content"),
        ...
        _createWrapper: function() {
            ...
            this._addClass(this.uiDialog, "ui-dialog", "ui-widget ui_widget_content ui-front"),
        ...
        _createButtonPane: function() {
            ...
            this._addClass(this.uiDialogButtonPane, "ui-dialog-buttonpane", "ui_widget_content ui-helper-clearfix"),
    ...
    t.widget("ui.progressbar", {
        ...
        _create: function() {
            ...
            this._addClass("ui-progressbar", "ui-widget ui_widget_content"),
    ...
    t.widget("ui.selectmenu", [t.ui.formResetMixin, {
        ...
        _drawButton: function() {
            ...
            this._addClass(this.button, "ui_selectmenu_button ui_selectmenu_button-closed", "ui-button ui-widget"),
        ...
        _drawMenu: function() {
            ...
            this._addClass(this.menuWrap, "ui_selectmenu_menu", "ui-front"),
        ...
        _refreshMenu: function() {
            ...
            this.menuItems = this.menu.find("li").not(".ui-selectmenu-optgroup").find(".ui_menu_item-wrapper"),
            this._rendered = !0,
        ...
        _documentClick: {
            mousedown: function(e) {
                this.isOpen && (t(e.target).closest(".ui_selectmenu_menu, #" + t.ui.escapeSelector(this.ids.button)).length || this.close(e))
            }
        },
        _buttonEvents: {
            mousedown: function() {
        ...
        _toggleAttr: function() {
            ...
            this._removeClass(this.button, "ui_selectmenu_button-" + (this.isOpen ? "closed" : "open"))._addClass(this.button, "ui_selectmenu_button-" + (this.isOpen ? "open" : "closed"))._toggleClass(this.menuWrap, "ui-selectmenu-open", null, this.isOpen),
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _create: function() {
            ...
            this._addClass("ui-slider ui-slider-" + this.orientation, "ui-widget ui_widget_content"),
            this._refresh(),
            this._animateOff = !1
        },
        _refresh: function() {
    ...
    t.widget("ui.spinner", {
        ...
        _draw: function() {
            this._enhance(),
            this._addClass(this.uiSpinner, "ui-spinner", "ui-widget ui_widget_content"),
    ...
    t.widget("ui.tabs", {
        ...
        options: {
            ...
            classes: {
                ...
                "ui_tabs_nav": "ui-corner-all",
                "ui_tabs_panel": "ui-corner-bottom",
        ...
        _create: function() {
            var e = this
              , i = this.options;
            this.running = !1,
            this._addClass("ui-tabs", "ui-widget ui_widget_content"),
        ...
        _processTabs: function() {
            ...
            this._addClass(this.tablist, "ui_tabs_nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"),
            ...
            this._addClass(this.panels, "ui_tabs_panel", "ui_widget_content"),
    ...
    t.widget("ui.tooltip", {
        ...
        _tooltip: function(e) {
            ...
            this._addClass(i, "ui-tooltip", "ui-widget ui_widget_content"),
